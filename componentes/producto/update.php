        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section class="app-user-edit">
                    ...
                    <form class="form-validate" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" enctype='multipart/form-data'>
                      <div class="row">
                        <div class="col-md-2 <?php echo (!empty($code_err)) ? 'has-error' : ''; ?>">
                            <label>code</label>
                        ...
                        <div class="col-md-2 <?php echo (!empty($stock_err)) ? 'has-error' : ''; ?>">
                            <label>stock</label>
