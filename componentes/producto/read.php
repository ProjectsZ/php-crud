                            ...
                            <ul class="nav nav-pills" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center active" id="account-tab"
                                        ...
                                        aria-selected="true">
                                        <i data-feather="eye"></i><span class="d-none d-sm-block">mostrar</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <?php echo
                                ...
                                <li class="nav-item">
                                    <?php echo
                                        ...
                                        href='delete.php?id=". $row['id'] ."' aria-selected='false'>
                                ...
                                <!-- imagen del producto -->
                                    <?php
                                        if (!empty($image)) {
                                            ...
                                            echo '<img src="' . $image . '" class="user-avatar users-avatar-shadow rounded mr-2 my-25 cursor-pointer" alt="Uploaded Image"
                                                    width="250">';
                                            echo '</div>';
                                        }
                                    ?>
                                        ...
                                        <div class="media-body mt-50">
                                            ...
                                            <div class="col-12 d-flex mt-1 px-0">
                                               ...
                                               <?php echo 
                                                ...
                                                '<span class="apexcharts-legend-marker" rel="3" data:collapsed="false" 
                                                style="background: '. $color .' !important; color: '. $color .'; height: 24px; width: 24px; left: -3px; top: 1px; border-width: 0px; 
                                                border-color: '. $color .'; border-radius: 12px;"></span>';
                                                ?>
                                            </div>
                                            <div class="col-12 d-flex mt-1 px-0">
                                                 <?php echo  
                                    ...
                                    <div class="mb-4 text-wrap" style="max-inline-size: 1200px;"> 
                                    ...
                                    <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                                        <a href="app-producto.php" class="btn btn-outline-secondary"> volver </a>
                                    </div>
                                </div>
                                <!-- Account Tab ends -->
