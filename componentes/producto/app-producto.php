                ...
                <section class="app-user-edit">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="media mb-2">
                                        ...
                                        <div class="media-body mt-50">
                                            ...
                                            <div class="col-12 d-flex mt-1 px-0">
                                                ...
                                                <button
                                                    class="btn btn-outline-secondary d-none d-sm-block">Remove</button>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Username"
                                                        value="eleanor.aguilar" name="username" id="username" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Name"
                                                        value="Eleanor Aguilar" name="name" id="name" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="WinDon Technologies Pvt Ltd" placeholder="Company name"
                                                        id="company" />
                                                </div>
                                            </div>
                                ...
                                <div class="content-wrapper">
                                    ...
                                    <div class="content-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <p>Read full documnetation <a href="https://datatables.net/"
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo "<table class='dt-multilingual table'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>#</th>";
                                        echo "<th>codigo</th>";
