...
<head>
    ...
    <meta name="description"
        content="CompreShop admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords"
        content="admin template, CompreShop admin template, dashboard template, flat admin template, responsive admin template, web app">
...
<body class="vertical-layout vertical-menu-modern content-left-sidebar navbar-floating footer-static  "
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon"
                    ...
                    <div class="search-input">
                        ...
                        <input class="form-control input" type="text" placeholder="Explore CompreShop..." tabindex="-1"
                            data-search="search">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand"
                        ...
                        <h2 class="brand-text">CompreShop</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i
                            ...
                            class="badge badge-light-warning badge-pill ml-auto mr-1">1</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center"
                                href="componentes/dashboard/dashboard-ecommerce.html"><i data-feather="circle"></i><span
    ...
    <div class="app-content content todo-application">
        ...
        <div class="content-area-wrapper">
            ...
            <img src="https://cdn.vox-cdn.com/thumbor/75uicUdgk65_lUpNT_TdrpY9XXk=/0x0:7999x4000/1200x675/filters:focal(3361x1361:4639x2639)/cdn.vox-cdn.com/uploads/chorus_image/image/69333291/GettyImages_1043605040.0.jpg" alt="">
